# =============================================================================
# done.fish — Smart Command Completion Notifications (Fish Shell)
# =============================================================================
# License        : MIT
# Original       : Francisco Lourenço & Daniel Wehner
# Refactor Scope : Formatting, structure, readability only
...
# =============================================================================
# Helper: Run PowerShell scripts (Windows / WSL)
# =============================================================================
...
# Supports: X11, Wayland (Sway/Hyprland), tmux, screen, Windows
# =============================================================================
...
'
        ...
        # Fallback (non-graphical sessions)
        echo 12345
    end
end

# =============================================================================
# Check if command window is still focused
# =============================================================================
function __done_is_process_window_focused
    ...
    set -l __done_focused_window_id (__done_get_focused_window_id)
...
# Capture focused window before command execution
